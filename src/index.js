...
// Generates the HTML table used to visualize Booth's algorithm
...
function onClickCreateTable() {
    ...
    const bitSize = parseInt(document.querySelector("select").value, 10);
    ...
    try {
        ...
        multiplicand = parseInt(multiplicand, 10);
